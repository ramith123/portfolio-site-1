...
const About = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        <SVG icon="codingInterface" hiddenMobile width={6} color="icon_blue" left="50%" top="75%" />
        <SVG icon="upDown" hiddenMobile width={8} color="icon_darkest" left="70%" top="20%" />
        <SVG icon="codingSlash" width={8}  color="icon_darkest" left="25%" top="5%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="codingSlash" width={12}  color="icon_brightest" left="95%" top="50%" />
      ...
      <SVG icon="codingInterface" width={12} color="icon_darkest" left="20%" top="30%" />
